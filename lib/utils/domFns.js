...
export function addUserSelectStyles(doc: ?Document, container: ?string) {
  if (!doc) return;
  ...
  if (doc.getElementById(container)) {
    addClassName(doc.getElementById(container), 'react-draggable-transparent-selection');
  }else{
    addClassName(doc.body, 'react-draggable-transparent-selection');
  }
}

export function removeUserSelectStyles(doc: ?Document, container: ?string) {
  if (!doc) return;
  try {
    if (doc.getElementById(container)) {
      removeClassName(doc.getElementById(container), 'react-draggable-transparent-selection');
    }else{
