...
class Draggable extends React.Component<DraggableProps, DraggableState> {
  ...
  render(): ReactElement<any> {
    ...
    console.log('555555556666', this.props)
    return (
      <DraggableCore {...draggableCoreProps} onStart={this.onDragStart} onDrag={this.onDrag} onStop={this.onDragStop} container={this.props.container}>
