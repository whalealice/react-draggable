...
export default class DraggableCore extends React.Component<DraggableCoreProps, DraggableCoreState> {
  ...
  componentDidMount() {
    ...
    console.log('aaaaa', this.props.container)
  }
  ...
  handleDragStart: EventHandler<MouseTouchEvent> = (e) => {
    ...
    if (this.props.enableUserSelectHack) addUserSelectStyles(ownerDocument, this.props.container);
  ...
  handleDragStop: EventHandler<MouseTouchEvent> = (e) => {
    ...
    if (thisNode) {
      ...
      if (this.props.enableUserSelectHack) removeUserSelectStyles(thisNode.ownerDocument, this.props.container);
    }
